...
(function (exp) {
  ...
  const reviewsArr = [
    {
      name: "Patrick Sinkmars",
      time: "8 hours ago",
      header: "You received it?",
      product: "264687852",
      // image: "./assets/1.jpg",
      review: "Has anyone submitted an application yet? Have you received it?",
    },
    {
      name: "Olivia Scott",
      time: "2 days ago",
      ...
      product: "26468789",
      // image: "./assets/2.jpg",
      review: "Thank you very much! I received yesterday the case I ordered! For £1.78 I got a luxury perfume and a camera!",
    },
    {
      name: "Yerodin Blignaut",
      time: "4 days ago",
      header: "I love it!",
      product: "26468783",
      // image: "./assets/3.jpg",
      review: "It is fantastic! I used to buy such cases only at auctions! but £1.78! THANK YOU!",
    },
    {
      name: "Imka McKenzie",
      time: "5 days ago",
      header: "Just great!",
      // image: "./assets/4.jpg",
      review: "We received the case this morning! The goods inside were a pleasant surprise! Thanks to the airport for not giving it away!",
    },
    {
      name: "Karel Turgeon",
      time: "5 days ago",
      ...
      product: "26468784",
      // image: "./assets/5.jpg",
      review: "Thanks for giving us the chance to buy a lost suitcase! I received it with clothes and a Casio watch!.",
    },
  ];
